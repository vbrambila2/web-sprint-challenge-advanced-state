...
export function Wheel(props) {
  ...
  return (
    <div id="wrapper">
      <div id="wheel">
        <div className={wheel === 0 ? "cog active" : "cog"} style={{ "--i": 0 }}>{ letter }</div>
        <div className={wheel === 1 ? "cog active" : "cog"} style={{ "--i": 1 }}></div>
        <div className={wheel === 2 ? "cog active" : "cog"} style={{ "--i": 2 }}></div>
        <div className={wheel === 3 ? "cog active" : "cog"} style={{ "--i": 3 }}></div>
        <div className={wheel === 4 ? "cog active" : "cog"} style={{ "--i": 4 }}></div>
        <div className={wheel === 5 ? "cog active" : "cog"} style={{ "--i": 5 }}></div>{/* --i is a custom CSS property, no need to touch that nor the style object */}
      </div>
      <div id="keypad">
